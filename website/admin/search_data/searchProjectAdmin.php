...
if (isset($_POST['query'])) {
    ...
    $sql = "SELECT project.*, 
               CONCAT(student1.firstname, ' ', student1.lastname) AS student1_name,            
               CONCAT(student2.firstname, ' ', student2.lastname) AS student2_name,             
               CONCAT(student3.firstname, ' ', student3.lastname) AS student3_name,           
               CONCAT(teacher1.position, ' ', teacher1.firstname, ' ', teacher1.lastname) AS teacher1_name,
               CONCAT(teacher2.position, ' ', teacher2.firstname, ' ', teacher2.lastname) AS teacher2_name,
               CONCAT(referee.position, ' ', referee.firstname, ' ', referee.lastname) AS referee_name,
               CONCAT(referee1.position, ' ', referee1.firstname, ' ', referee1.lastname) AS referee1_name,
               CONCAT(referee2.position, ' ', referee2.firstname, ' ', referee2.lastname) AS referee2_name
        FROM `project`
        ...
        WHERE project.project_nameTH LIKE :inputText
           ...
           OR CONCAT(student1.firstname, ' ', student1.lastname) LIKE :inputText      
           OR CONCAT(student2.firstname, ' ', student2.lastname) LIKE :inputText
           OR CONCAT(student3.firstname, ' ', student3.lastname) LIKE :inputText   
           OR CONCAT(teacher1.position, ' ', teacher1.firstname, ' ', teacher1.lastname) LIKE :inputText
           OR CONCAT(teacher2.position, ' ', teacher2.firstname, ' ', teacher2.lastname) LIKE :inputText
           OR CONCAT(referee.position, ' ', referee.firstname, ' ', referee.lastname) LIKE :inputText
           OR CONCAT(referee1.position, ' ', referee1.firstname, ' ', referee1.lastname) LIKE :inputText
           OR CONCAT(referee2.position, ' ', referee2.firstname, ' ', referee2.lastname) LIKE :inputText";
    ...
    if ($result) {
        ...
        foreach ($result as $project) {
            ...
            if (strpos($project['project_nameTH'], $inputText) !== false) {
                ...
                $found = true;
            } elseif (strpos($project['student1_name'], $inputText) !== false) {
                echo '<a class="list-group-item list-group-item-action border-1">'; //////////////
                echo str_replace($inputText, '<strong>' . $inputText . '</strong>',  $project['student1_name']);
                echo ' <span style="font-size: 0.8em;">(นักศึกษา)</span>';
                $found = true;
            } elseif (strpos($project['student2_name'], $inputText) !== false) {
                echo '<a class="list-group-item list-group-item-action border-1">'; //////////////
                echo str_replace($inputText, '<strong>' . $inputText . '</strong>', $project['student2_name']);
                echo ' <span style="font-size: 0.8em;">(นักศึกษา)</span>';
                $found = true;
            } elseif (strpos($project['student3_name'], $inputText) !== false) {
                echo '<a class="list-group-item list-group-item-action border-1">'; //////////////
                echo str_replace($inputText, '<strong>' . $inputText . '</strong>', $project['student3_name']);
                echo ' <span style="font-size: 0.8em;">(นักศึกษา)</span>';
                $found = true;
    ...
    $isTeacherAdvisor = strpos($inputText, '(เป็นอาจารย์ที่ปรึกษา)') !== false;
