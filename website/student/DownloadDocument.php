...
<div class="HeaderBg shadow">
  <div class="container">
    <navbar_std-component></navbar_std-component>
  </div>
</div>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td scope="row" class="text-start"><?php echo $document['document_name']; ?></td>
                          <td class="text-start"><a href="<?php echo '.././admin/uploadfileDocument/' . $document['document_path']; ?>" target="_blank"><?php echo $document['document_path']; ?></a></td>
