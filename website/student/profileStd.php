...
<head>
    ...
    <title>โปรไฟล์ของนักศึกษา</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-3 py-3">
                ...
                <div class="row g-5">
                    ...
                    <h1 class="h2" style="font-family: 'IBM Plex Sans Thai', sans-serif;">ข้อมูลโปรไฟล์ของนักศึกษา</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb fs-5 mt-3 ms-3 ">
                                <li class="breadcrumb-item"><a href="./Stdpage.php">หน้าหลัก</a></li>
                                <li class="breadcrumb-item active" aria-current="page">โปรไฟล์ของนักศึกษา</li>
                            </ol>
                        </nav>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" id="username" placeholder="Username" value="<?php echo $data['student_id']; ?>" readonly>
                                    </div>
                                </div>
